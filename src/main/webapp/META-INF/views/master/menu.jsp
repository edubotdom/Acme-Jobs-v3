...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.anonymous.botiaBulletin" access="isAnonymous()">
			<acme:menu-suboption code="master.menu.anonymous.botiaBulletin.list" action="/anonymous/botiaBulletin/list"/>
			<acme:menu-suboption code="master.menu.anonymous.botiaBulletin.create" action="/anonymous/botiaBulletin/create"/>
		</acme:menu-option>
